...
Смысл в том, что для константы STDIN требуется модуль CLI.
Но можно не волноваться, т.к. этот модуль уже более 10 лет входит в дистрибутив php по умолчанию.
*/
